...
/*   Updated: 2021/11/08 09:45:35 by cdiaz-fl         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include	"push_swap.h"

void	ft_little_chunk(t_param *val, t_node *aux, int i)
{
	int	count;

	count = (val->chunk_size->content - 6);
...
void	ft_medium_chunk(t_param *val, t_node *aux, int i)
{
	...
	count = (val->chunk_size->content - 12);
	while (--i && aux->next != NULL)
		aux = aux->next;
	printf("\naux grande es       %d      \n", aux->content);
	val->chunks_count = count;
...
void	ft_medium_chunk_2(t_param *val, t_node *aux, int i)
{
	...
	count = (val->chunk_size->content - 18);
	while (--i && aux->next != NULL)
		aux = aux->next;
...
void	ft_large_chunk(t_param *val, t_node *aux, int i)
{
	...
	count = (val->chunk_size->content - 25);
	while (--i && aux->next != NULL)
		aux = aux->next;
...
void	ft_large_chunk_2(t_param *val, t_node *aux, int i)
{
	...
	count = (val->chunk_size->content - 31);
	while (--i && aux->next != NULL)
		aux = aux->next;
